...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, int? status_code) failure,
    required TResult Function() loading,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(String message, int? status_code)? failure,
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String message, int? status_code});
}
...
class __$$FailureImplCopyWithImpl<T, $Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? message = null, Object? status_code = freezed}) {
    return _then(
      _$FailureImpl<T>(
        null == message
            ? _value.message
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(this.message, {this.status_code});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(message: $message, status_code: $status_code)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, message, status_code);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(message, status_code);
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final String message, {final int? status_code}) =
      _$FailureImpl<T>;
